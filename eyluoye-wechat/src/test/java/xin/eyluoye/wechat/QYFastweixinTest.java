...
import xin.eyluoye.wechat.api.enums.MediaType;
import xin.eyluoye.wechat.company.api.*;
import xin.eyluoye.wechat.company.api.config.QYAPIConfig;
import xin.eyluoye.wechat.company.api.entity.*;
import xin.eyluoye.wechat.company.api.enums.QYMenuType;
import xin.eyluoye.wechat.company.api.enums.QYResultType;
import xin.eyluoye.wechat.company.api.response.*;
import xin.eyluoye.wechat.company.message.QYArticle;
import xin.eyluoye.wechat.company.message.QYNewsMsg;
import xin.eyluoye.wechat.company.message.QYTextMsg;
import xin.eyluoye.wechat.util.CollectionUtil;
