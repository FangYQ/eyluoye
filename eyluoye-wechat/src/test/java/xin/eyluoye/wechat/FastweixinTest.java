...
import xin.eyluoye.wechat.api.*;
import xin.eyluoye.wechat.api.config.ApiConfig;
import xin.eyluoye.wechat.api.entity.*;
import xin.eyluoye.wechat.api.enums.*;
import xin.eyluoye.wechat.api.response.*;
import xin.eyluoye.wechat.message.MpNewsMsg;
...
//        String secret = "0705aafac0bef944de4c485d71fce900";
        String appid = "wxbd5c8f0b5e7515f6";
        String secret = "051846a038ec4332223354b8d0c93357";
...
//        uploadImageMaterial(config);
    ...
    public void saveAppInfo(){
        ...
        jedis.set("appid", appid);
        jedis.set("appsecret", secret);
        jedis.save();
        jedis.close();
    }
