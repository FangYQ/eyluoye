...
import xin.eyluoye.wechat.company.api.response.DownloadMediaResponse;
import xin.eyluoye.wechat.company.api.response.UploadMediaResponse;
import xin.eyluoye.wechat.util.JSONUtil;
import xin.eyluoye.wechat.util.NetWorkCenter;
import xin.eyluoye.wechat.util.StreamUtil;
