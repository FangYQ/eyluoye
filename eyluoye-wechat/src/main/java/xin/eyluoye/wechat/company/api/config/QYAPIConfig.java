package xin.eyluoye.wechat.company.api.config;

import xin.eyluoye.wechat.api.config.ChangeType;
import xin.eyluoye.wechat.api.config.ConfigChangeNotice;
import xin.eyluoye.wechat.api.response.GetJsApiTicketResponse;
import xin.eyluoye.wechat.api.response.GetTokenResponse;
import xin.eyluoye.wechat.exception.WeixinException;
