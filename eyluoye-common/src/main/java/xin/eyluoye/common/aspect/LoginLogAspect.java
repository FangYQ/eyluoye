package xin.eyluoye.common.aspect;

import xin.eyluoye.common.constant.SystemConstant;
...
import xin.eyluoye.common.utils.IpUtils;
import xin.eyluoye.common.utils.JSONUtils;
...
public class LoginLogAspect {
     ...
     * @param retValue
     */
    @AfterReturning(pointcut = "execution(* xin.eyluoye.shiro.controller.SysLoginController.login(..))", returning = "retValue")
     ...
     * @param joinPoint
     */
    @Before("execution(* xin.eyluoye.shiro.controller.SysLoginController.logout(..))")
